...
dotfiles_xdg_config_dir=(.alacritty .compton .dunst .htop .i3 .i3blocks .rofi fish nvim)
pacman_packs=(fish git tmux neovim htop fzf bat ripgrep feh xautolock wget ttf-hack rofi picom alacritty arc-gtk-theme arc-solid-gtk-theme adobe-source-sans-pro-fonts vlc libreoffice file-roller redshift numlockx pulsemixer)
yay_packs=(i3lock-fancy-rapid-git dunst-git  paper-icon-theme-git )
